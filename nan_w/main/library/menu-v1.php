<nav class="grow-0 skew-menu flex flex-col items-center justify-center">
    ...
    <div class="relative">
      ...
      <img src="./main/img/education-concept-student-studying-brainstorming-campus-concept-close-up-students-discussing-their-subject-books-textbooks-selective-focus.jpg" />
      ...
      <div class="flex flex-row gap-2 items-center absolute z-20 " style="left:50%; top: 50%; transform: translate(-50%, -50%); width: 90%">
        ...
        <div class="relative flex flex-row items-center w-10/12">   
          ...
          <img class="w-4 h-4 absolute top-[50%] translate-y-[-50%] right-2 hidden"  src="./main/img/mic.png"  />  
        </div>  
