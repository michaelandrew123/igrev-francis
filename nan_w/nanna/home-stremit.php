                ...
                <div class=" mt-2">
                    ...
                    <div class="relative overflow-x-hidden w-full"  >
                        <div class="relative">
                            ...
                            <div class="flex flex-row gap-2 overflow-x-auto home-panel-recent">

                            </div>


                            <ul class="flex flex-row gap-2 overflow-x-auto home-panel-recent" id="home-recent-panel">


                                <li class="flex-1 w-80 shadow-lg  drop-shadow-white">
                                    ...
                                    <div class="px-6 py-4 w-[10rem] ">
                                        <span class="font-bold  text-xl mb-2">맛있는 1 </span>
                                        <p class="text-gray-700  text-base">
                                            아주 맛있는
                                        </p>
                                    </div>
                                </li>
                                <li class="flex-initial shadow-lg  drop-shadow-white">
                                    <img class="w-full rounded-lg" src="https://d3kzx7mqemhf0.cloudfront.net/catchtable/comm_2311710455207542.webp?small400" alt="Mountain">
                                    <div class="px-6 py-4 w-[10rem] ">
                                        <span class="font-bold  text-xl mb-2">맛있는 1 </span>
                                        <p class="text-gray-700  text-base">
             ...
             -->
                ...
                <div class=" mt-2 ">
                    ...
                    <ul class="library-panel-section grid grid-rows-2 grid-flow-col gap-2 overflow-x-auto min-[639px]:overflow-x-auto  ">
                        <li class="flex-1 shadow-lg  drop-shadow-white">
                            <img class="w-full rounded-lg" src="https://d3kzx7mqemhf0.cloudfront.net/catchtable/comm_2311710455207542.webp?small400" alt="Mountain">
                            <div class="px-6 py-4">
                                <span class="font-bold  text-xl mb-2">맛있는 1 </span>
                                <p class="text-gray-700  text-base">
