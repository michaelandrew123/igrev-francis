	...
	<div class="flex flex-col  ml-[15px] mr-[15px] pt-0">
		<div class="flex flex-row gap-3 items-stretch ">
			...
			<div class="w-6/12 " style=" height: 185px !important;" >
				<img class="flex-1 rounded-lg m-auto  w-full h-full"  src="https://i.pinimg.com/originals/f3/d9/4c/f3d94ce409e91117dde4de2ad697f4d9.jpg" alt="Mountain">
			</div>
			<div class="flex flex-col w-6/12 flex-1 justify-between">
				<!-- Share icon -->
				<div class="flex flex-end justify-end gap-2">
					
					<img class="w-5 h-5  " src="./img/bookmark.png" alt="Mountain">
					<img class="w-5 h-5"  src="./img/share.png" />
				</div>


				<div class="text-[18px]"> 
					<div class="font-bold">The shadow of the latter writer  </div>
					<div class="font-bold">How to live </div>  
				</div>
				...
				<div class="flex flex-col"> 
					<div class="text-[14px]">
						<div class="font-bold">Aiden KIM</div>
						<div>Created 2022-6-29</div>
						<div>Edited 2022-6-29</div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="flex flex-col gap-2 mt-[20px] mb-[45px]">
			<a href="./answering-multiple-choice.php" class=" w-full  py-3 px-2 border border-slate-400 text-center drop-shadow-lg bg-blue-600 text-white font-bold"> 
				<div> Start Quiz (Multiple Choice) </div> 
			</a> 
			<a href="./answering-open-ended.php" class=" w-full  py-3 px-2 border border-slate-400 text-center drop-shadow-lg bg-blue-600 text-white font-bold"> 
