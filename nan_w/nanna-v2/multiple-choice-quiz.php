...
<!----> 
    ...
    <div class=" flex flex-col h-screen  gap-2 mx-[15px]">  
        <div class="grow flex flex-col justify-start  w-full ">  
            <div class="text-xl font-bold">Multiple Choice Quiz</div> 
            <div class="mb-3 mt-[35px] ">  
                <label for="wiki" class="form-label inline-block mb-2 text-gray-700  font-bold text-sm">Quiz Title</label>
                <textarea style="resize: none;" class="auto-resize-textarea4 form-control  block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"  placeholder="KIIP ©단계 평가문제"></textarea>
            </div>  
            <div class="w-full">
...
<script type="text/javascript">
	let textareas = document.getElementsByClassName("auto-resize-textarea4");
