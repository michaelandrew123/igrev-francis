        ...
        <div class="flex flex-col gap-2 mx-[15px] mt-[30px] mb-[10px]">  
            ...
            <div class=" "> 
                <div class="  flex flex-row justify-between">
                    ...
                    <div class="flex flex-row items-center gap-2 recommended-gl">
                        <a href="#" id="recommended-grid">
                            <img src="./img/visualization.png" class="w-5 h-4" />
                        </a>

                        <a href="#" id="recommended-list">
