                                        ...
                                        <div class="flex flex-row justify-center w-full mt-5">
                                            <div class="flex flex-col gap-3 w-full text-center">
                                                    <div class="form-check">
                                                        ...
                                                        <div class="w-full inline-block px-6 py-2.5 text-gray-700 font-medium text-xs leading-tight uppercase rounded  transition duration-150 ease-in-out border bg-blue-500 text-white"  >1 Light</div>
                                

                                                    </div>
                                                    <div class="form-check">
                                                        <div class="w-full inline-block px-6 py-2.5 text-gray-700 font-medium text-xs leading-tight uppercase rounded  transition duration-150 ease-in-out border border-red-500"  >2 Light</div>
