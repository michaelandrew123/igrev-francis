	...
	<div class="grow-0 flex flex-col mt-[35px] mb-[20px] ">
		<div class="flex flex-row justify-between">
			<div class="flex flex-row items-center ">			
				<div class="font-bold text-3xl">콘텐츠 만들기</div> 
			</div> 
		</div> 
	</div>
	<!-- End Progress Bar -->
		...
		<div class="h-5/6 flex flex-col  w-full gap-[15px]  " id="create-quiz-btn">
			<a href="#" >
                <div class="relative flex rounded-lg justify-center h-[200px] bg-[url('https://tse2.mm.bing.net/th?id=OIP.tBXFplk1QJIsLDGreNd-WAHaEo&pid=Api&P=0')] bg-cover" >
                    ...
                    <div onclick="location.href='./quiz-step-2.php'" class=" z-10 block p-6 rounded-lg shadow-lg   max-w-sm flex flex-row justify-center items-center text-white h-full w-full font-bold text-2xl">
                        WIKI 
                    </div>
                </div>
	   	 	</a>
